/**
 * @file Entry-point of the BetterCF core code a.k.a. runs the extension modules
 */
...
async function run() {
    ...
    env.run_when_ready(tryCatch(function() {
        ...
        if (v != env.version) {
            ...
            env.global.Codeforces.showMessage(`BetterCF was updated to version ${env.version}!
