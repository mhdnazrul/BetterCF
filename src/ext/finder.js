...
function Result(props) {
    if (!props.href && !props.onClick) {
        console.error(`BetterCF Error!\n` +
                      `Please report this on GitHub: https://github.com/anomalyco/BetterCF\n` +
        ...
        return [
            {
                ...
                onClick() {
                    close();
                    dom.$('.bettercf-tutorial-btn').click();
                }
            },
            {
                key: "submit",
...
const create = once(async function() {
    ...
    let modal = (
        <div className="bettercf-modal bettercf-hidden" tabindex="0">
            <div className="bettercf-modal-background" onClick={close}/>
...
async function close() {
    ...
    modal.classList.add('bettercf-hidden');
    input.value = "";
