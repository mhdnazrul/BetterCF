/**
 * @file Manages BetterCF configuration with localStorage and creates the settings UI
 */
...
export function load() {
    ...
    config = safe (JSON.parse, {}) (localStorage.bettercf);
                 ...
                 : env.ready(function()
{
    ...
    let modal = (
        <div className="bettercf-config bettercf-modal bettercf-hidden">
            <div className="bettercf-modal-background" onClick={closeUI}/>
            <div className="bettercf-modal-inner">
    ...
    let modalBtn = <a className="bettercf-config-btn">[++]</a>;
    dom.on(modalBtn, 'click', ev => {
        ev.preventDefault();
        modal.classList.remove('bettercf-hidden');
    });
...
export function closeUI() {
    dom.$('.bettercf-config').classList.add('bettercf-hidden');
    save();
}
